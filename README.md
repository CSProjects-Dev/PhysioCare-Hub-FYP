...
2. Monitor body posture in real-time using computer vision

3. Give corrective feedback during exercises

4. Allow patients to track their progress and reduce dependency on physical physiotherapy sessions

5. Offer post-therapy feedback to improve system recommendations
...
5. Architecture: Web-based Client–Server Model
...
2. Medical History-based Therapy Selection

3. Live Webcam-based Exercise Monitoring

4. Real-time Feedback (Text)

5. Session Summary & User Feedback

6. Wellness Section with exercise guide videos and diet plans for different patient types

7. Chatbot Assistance to answer user queries and guide through exercises
